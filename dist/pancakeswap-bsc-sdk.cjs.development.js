...
var Pair = /*#__PURE__*/function () {
  ...
  Pair.getAddressFromFactory = function getAddressFromFactory(tokenA, tokenB, exchangeAddress, provider) {
    try {
      if (provider === undefined) provider = providers.getDefaultProvider(providers.getNetwork(exports.ChainId.MAINNET));
      var tokens = tokenA.sortsBefore(tokenB) ? [tokenA, tokenB] : [tokenB, tokenA]; // does safety checks

      return Promise.resolve(new contracts.Contract(exchangeAddress, factoryAbi, provider).getPair(tokens[0].address, tokens[1].address));
    } catch (e) {
...
//# sourceMappingURL=pancakeswap-bsc-sdk.cjs.development.js.map
