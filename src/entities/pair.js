...
export class Pair {
    ...
    static getAddress(tokenA, tokenB, factoryAddress = FACTORY_ADDRESS) {
        var _a;
        ...
        if (((_a = PAIR_ADDRESS_CACHE === null || PAIR_ADDRESS_CACHE === void 0 ? void 0 : PAIR_ADDRESS_CACHE[tokens[0].address]) === null || _a === void 0 ? void 0 : _a[tokens[1].address]) === undefined) {
            PAIR_ADDRESS_CACHE = {
                ...
                [tokens[0].address]: {
                    ...
                    [tokens[1].address]: getCreate2Address(factoryAddress, keccak256(['bytes'], [pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), INIT_CODE_HASH)
                }
            };
        }
